      ...
      <section className="mt-40 mb-20">
        <div className="w-9/12 mx-auto font-mono">
          <div className="flex flex-wrap lg:justify-between -mx-4">
            <div className="w-full lg:w-1/2 xl:w-6/12 md:px-4 px-2">
              <div className="mb-12 lg:mb-0">
                ...
                <div className="flex mb-8 max-w-[380px] w-full">
                  <div
                    className="
                     max-w-[60px]
                     sm:max-w-[70px]
                  ...
                  <div className="mb-6">
                    <textarea
                      ...
                      className="
                        ...
                        py-3
                        px-[14px]
                        text-secondary bg-transparent input-bordered border-2 border-primary
                        border-[f0f0f0]
                        resize-none
                        outline-none
                        focus-visible:shadow-none
